...
const int MQTT_PORT = 1883;
const char MQTT_CLIENT_ID[] = "123123asdwqeasdwasdwedqwffefeee";  // CHANGE IT AS YOU DESIRE
const char MQTT_USERNAME[] = "";                                            // CHANGE IT IF REQUIRED, empty if not required
const char MQTT_PASSWORD[] = "";                                            // CHANGE IT IF REQUIRED, empty if not required

// The MQTT topics that Arduino should publish/subscribe
const char PUBLISH_TOPIC[] = "66070286/emailspin";    // CHANGE IT AS YOU DESIRE
const char SUBSCRIBE_TOPIC[] = "66070286/emailspin";  // CHANGE IT AS YOU DESIRE
...
void sendToMQTT() {
  ...
  // int potValue = analogRead(potPin);
  // String val_str = String(temperatureC);
  String val_str = String(sensorValue);
